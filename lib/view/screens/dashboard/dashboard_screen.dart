...
import 'package:for_car_delivery/helper/notification_helper.dart';
import 'package:for_car_delivery/utill/color_resources.dart';
...
import 'package:for_car_delivery/view/base/custom_botom_navy_bar.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    super.initState();
    Get.find<MenuController>().selectHomePage(first: false);
  ...
  BottomNavyBarItem _barItem(String icon, String label, int index, MenuController menuController) {

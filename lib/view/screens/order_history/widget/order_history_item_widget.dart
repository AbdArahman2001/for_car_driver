...
import 'package:for_car_delivery/view/screens/order/widget/cal_chat_widget.dart';
              ...
              Positioned(
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: SizedBox(width: Get.find<LocalizationController>().isLtr? Get.context.width<= 400? 150 : 160 :Get.context.width<= 400? 130 : 140,
                      child: Column(children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Text('${'expected_date'.tr} : ',style: rubikRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall),),
